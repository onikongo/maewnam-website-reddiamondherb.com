...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=<?php echo $_REQUEST['app'];?>">สาขา</a></font></div>
    ...
    <div><!-- Nav tabs -->
            	...
            	<div class="panel panel-default">
                  <div class="panel-heading">
                    ...
                    <!--<div align="right">-->
                        <button type="button"  class="btn btn-danger btn-sm pull-right but" onclick="fn.navigate('add')">เพิ่ม สาขา</button>
                    <!--</div>-->
                  </div>
                  <div class="panel-body nopad">
                    ...
                    <?php 
                    $sql = $dbc->Query("SELECT * FROM branch");
                    $i=1;
                    ...
                    {	
                        ...
                        <tr>
                            ...
                            <td data-th="Title" class="text-right"><?php echo explode("|",$row['name'])[0];?></td>
                            <td data-th="Title" class="text-right">
							<?php 
							$sec = $dbc->GetRecord("sector","*","id = '".$row['sector']."'");
                            ...
                            <td data-th="Action" class="text-center">
                                ...
                                <button type="button" class="buticonRem" onClick="fn.app.branch.dialog_delete('<?php echo $row['id'];?>',this)"><i class="fa fa-times" style="font-size:14px;"></i></button>
                            </td>
                            <td data-th="Status." class="text-center">
                            <?php if($row['status']==1)
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.branch.activ('<?php echo $row['id'];?>',this)">
                            ...
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.branch.activ('<?php echo $row['id'];?>',this)">
                                    <label for="cmn-toggle-<?php echo $i;?>"></label>
                                </div><?php
                            }?>
