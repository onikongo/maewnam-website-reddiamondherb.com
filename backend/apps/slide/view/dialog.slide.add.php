...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=<?php echo $_REQUEST['app'];?>">ภาพสไลด์</a> / เพิ่ม</font></div>
    	...
    	<div class="col-md-8 col-md-offset-2" style="padding:10px;">
        	<form class="form form-horizontal" id="myFromdetail">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <img id="txtIcon" src="/upload/thumb/lp.jpg" class="img-responsive" style="border:1px solid #999;">
                    </div>
                    <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.slide.saveImage()">บันทึก</button>
