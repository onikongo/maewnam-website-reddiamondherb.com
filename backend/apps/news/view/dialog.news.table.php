...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=<?php echo $_REQUEST['app'];?>">ข่าวสาร & กิจกรรม</a></font></div>
    ...
    <div><!-- Nav tabs -->
            	...
            	<div class="panel panel-default">
                  <div class="panel-heading">
                    ...
                    <!--<div align="right">-->
                        <button type="button"  class="btn btn-danger btn-sm pull-right but" onclick="fn.navigate('add')">เพิ่ม ข่าวสาร & กิจกรรม</button>
                    <!--</div>-->
                  </div>
                  <div class="panel-body nopad">
                        ...
                        <table class="table table-bordered rwd-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center no-sort">หัวข้อ</th>
                    ...
                    {	
                        ...
                        <tr>
                            ...
                            <td data-th="Title" class="text-right">"<?php echo $row['headline'];?></td>
                           <td data-th="Image" class="text-right"><img src="../../../../libs/<?php echo $row['photo'];?> " width="100"></td>
                            ...
                            <td data-th="Action" class="text-center">
                                ...
                                <button type="button" class="buticonRem" onClick="fn.app.news.dialog_delete('<?php echo $row['id'];?>',this)"><i class="fa fa-times" style="font-size:14px;"></i></button>
                            </td>
