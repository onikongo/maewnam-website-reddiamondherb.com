<?php
	...
	switch($section){
		case "view":
			include_once "apps/slide_photo/view/dialog.slide.table.php";
			break;
		case "add":
			include_once "apps/slide_photo/view/dialog.slide.add.php";
			break;
		case "edit":
			include_once "apps/slide_photo/view/dialog.slide.edit.php";
			break;
	}
	echo '</div>';
?>