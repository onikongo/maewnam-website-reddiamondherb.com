...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=blogs">Blogs & Event</a> / Event List</font></div>
	...
	<div class="panel panel-default">
      ...
      <div class="panel-body nopad">
        <div class="table-responsive nopad">
      	...
      	<?php 
		$sql = $dbc->Query("SELECT * FROM sub_blogs WHERE blogs = '".$id."'");
		$i=0;
		...
		{	
			...
			<tr>
                ...
                <td class="text-center">
        			...
        			<button type="button" class="buticonRem" onClick="fn.app.blogs.dialog_deleteEvent('<?php echo $row['id'];?>',this)"><i class="demo-icon icon-cancel">&#xe803;</i></button>
                </td>
                <td class="text-center">
                <?php if($row['status']==1)
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.blogs.activEvent('<?php echo $row['id'];?>',this)">
				...
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.blogs.activEvent('<?php echo $row['id'];?>',this)">
                        <label for="cmn-toggle-<?php echo $i;?>"></label>
                    </div><?php
				}?>
