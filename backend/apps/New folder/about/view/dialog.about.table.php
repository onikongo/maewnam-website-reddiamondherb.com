<?php
	...
	$dbc = new dbc;
	$dbc->Connect();
	$desc = $dbc->GetRecord("about_description","*","id=1");
...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=news">About Company</a></font></div>
<div class="col-md-12" style="padding:10px;">
    <div><!-- Nav tabs -->
    
        <!-- Nav tabs -->
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Company Description</a></li>
            <li role="presentation" class="active"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">About Company</a></li>
        </ul><!-- Nav tabs -->
        ...
        <div class="tab-content">
                ...
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <button class="btn btn-primary pull-right" id="multi-posts" type="button" onClick="fn.app.about.save_desc()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
            ...
            <div role="tabpanel" class="tab-pane active" id="profile">
            	<div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title">About Company</h3>
                    <!--<div align="right">-->
                  ...
                  <div class="panel-body nopad">
                    ...
                    <?php 
                    $sql = $dbc->Query("SELECT * FROM sub_about ");
                    $i=0;
                    ...
                    {	
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="buticonRem" onClick="fn.app.about.dialog_deleteEvent('<?php echo $row['id'];?>',this)"><i class="demo-icon icon-cancel">&#xe803;</i></button>
                            </td>
                            <td class="text-center">
                            <?php if($row['status']==1)
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.about.activ('<?php echo $row['id'];?>',this)">
                            ...
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.about.activ('<?php echo $row['id'];?>',this)">
                                    <label for="cmn-toggle-<?php echo $i;?>"></label>
                                </div><?php
                            }?>
