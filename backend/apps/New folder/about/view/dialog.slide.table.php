...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=homepage">Slide photo</a></font></div>
<div class="col-md-12" style="padding:10px;">
	<div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">Slide photo</h3>
        <!--<div align="right">-->
            <button type="button"  class="btn btn-danger pull-right but" onclick="fn.navigate('add')">Add Image</button>
        <!--</div>-->
      </div>
      <div class="panel-body nopad">
        <div class="table-responsive nopad">
      	...
      	<?php 
		$sql = $dbc->Query("SELECT * FROM slide_photo");
		$i=0;
		...
		{	
			...
			<tr>
                ...
                <td class="text-center"><img src="<?php echo $row['photo'];?>" width="100"></td>
                <td class="text-center"><?php echo $row['created'];?></td>
                <td class="text-center">
        			...
        			<button type="button" class="buticonRem" onClick="fn.app.slidePhoto.dialog_delete('<?php echo $row['id'];?>',this)"><i class="demo-icon icon-cancel">&#xe803;</i></button>
                </td>
                <td class="text-center">
                <?php if($row['status']==1)
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.slidePhoto.activ('<?php echo $row['id'];?>',this)">
				...
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.slidePhoto.activ('<?php echo $row['id'];?>',this)">
                        <label for="cmn-toggle-<?php echo $i;?>"></label>
                    </div><?php
				}?>
