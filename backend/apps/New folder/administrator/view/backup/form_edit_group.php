<?php
	...
	$sql = "SELECT * FROM customer_group WHERE cg_id=".$_REQUEST['id'];
	$rst = $dbc->Query($sql);
	$line = $dbc->Fetch($rst);
?>
<br>
<form id="edit_group" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="txtName" name="txtName" placeholder="Name" value="<?php echo $line['cg_name'];?>">
		</div>
	</div>
<!--	<div class="form-group">
