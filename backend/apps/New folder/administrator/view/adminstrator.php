...
<!-- Nav tabs -->
  <ul class="nav nav-tabs " role="tablist">
    ...
    <li role="presentation"<?php if($tab=="appprove")echo' class="active"'; ?>><a href="#appprove" aria-controls="profile" role="tab" data-toggle="tab">Group</a></li>
  ...
  <div class="tab-content " >
    ...
    <div class="col-md-4" align="right">
            <button type="button" class="btn btn-primary" onclick="fn.app.adminstrator.add_user()">Add</button>
            <button type="button" class="btn btn-danger" onclick="fn.app.adminstrator.remove_reward()">Remove</button>
        </div>
                ...
                <table id="tblCategory" class="table table-striped table-hover table-condensed table-bordered">
					...
					<?php
                        ...
                        while($line = $dbc->Fetch($rst)){
                            ...
                            echo '<td><button type="button" class="btn btn-default btn-xs" onclick="fn.app.adminstrator.dialog_edit_user('.$id.')">Change</button></td>';
                            echo '</tr>';
                        }
