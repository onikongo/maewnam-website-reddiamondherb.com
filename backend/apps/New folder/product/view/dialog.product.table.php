<?php
	...
	$dbc = new dbc;
	$dbc->Connect();
	$desc = $dbc->GetRecord("product_information","*","id=1");
...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=news">Product & Service</a></font></div>
<div class="col-md-12" style="padding:10px;">
    <div><!-- Nav tabs -->
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Product</a></li>
        </ul><!-- Nav tabs -->
            ...
            <div role="tabpanel" class="tab-pane " id="home">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
            		<form class="form form-horizontal" id="gallerydesc">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <button class="btn btn-primary pull-right" id="multi-posts" type="button" onClick="fn.app.product.save_desc()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
            ...
            <div role="tabpanel" class="tab-pane active" id="profile">
            	<div class="panel panel-default">
                  <div class="panel-heading">
                    ...
                    <!--<div align="right">-->
                        <button type="button"  class="btn btn-danger pull-right but" onclick="fn.navigate('add_cate')">Add Product category</button>
                    <!--</div>-->
                  </div>
                  <div class="panel-body nopad">
                    ...
                    <?php 
                    $sql = $dbc->Query("SELECT * FROM product_category");
                    $i=0;
                    ...
                    {	$name  = explode("|",$row['name']);
                        ...
                        <tr>
                            ...
                            <td class="text-center"><button type="button" class="btn  btn-info" onClick="fn.navigateEdit('product_table','<?php echo $row['id'];?>')">Add product</button></td>
                            <td class="text-center">
                                <button type="button" class="buticonEdit" onClick="fn.navigateEdit('edit_cate','<?php echo $row['id'];?>')"><i class="demo-icon icon-pencil">&#xe802;</i> </button>
                                <button type="button" class="buticonRem" onClick="fn.app.product.dialog_delete('<?php echo $row['id'];?>',this)"><i class="demo-icon icon-cancel">&#xe803;</i></button>
                            </td>
                            <td class="text-center">
                            <?php if($row['status']==1)
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.product.activ('<?php echo $row['id'];?>',this)">
                            ...
                            {
                                ?><div class="switch">
                                    <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.product.activ('<?php echo $row['id'];?>',this)">
                                    <label for="cmn-toggle-<?php echo $i;?>"></label>
                                </div><?php
                            }?>
