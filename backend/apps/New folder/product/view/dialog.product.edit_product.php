<?php
	...
	$dat = $dbc->GetRecord("products","*","id='".$_REQUEST['id']."'");
	$name = explode("|",$dat['name']);
	$desc = explode("|",$dat['detail']);
?>
<script>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    	<div class="col-md-12" style="padding:10px;">
            <form class="form form-horizontal" id="editproduct">
            <input type="hidden" name="txtID" value="<?php echo $_REQUEST['id'];?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" id="txtDesc" name="txtDesc" placeholder="Sub Description"><?php echo $desc[0];?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Sub Description (TH)</label>
                    <div class="col-sm-8">
                        <textarea class="form-control" id="txtDescTH" name="txtDescTH" placeholder="Sub Description"><?php echo $desc[1];?></textarea>
                    </div>
                </div> 
                <input type="hidden" id="parth" name="parth" value="<?php echo $dat['setting'];?>">
                </form>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <img src="<?php echo '../../../../'.$dat['setting'];?>" width="300">
                        </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.product.update_product('<?php echo $_REQUEST['id'];?>')">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
                        <button type="button"  class="btn btn-default pull-right"   onclick="javascript:window.history.go(-1);">Cancel</button>
