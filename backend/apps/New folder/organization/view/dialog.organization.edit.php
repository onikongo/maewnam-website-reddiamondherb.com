<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("gallery_photo","*","id='".$id."'");
?>
  ...
  <div class="panel-body">
    	<div class="col-md-12" style="padding:10px;">
        	<form class="form form-horizontal" id="myFromdetailEdit">
                ...
                <form class="form form-horizontal" id="myFrom" method="post" action="apps/gallery/xhr/action-up-photo.php"  role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.gallery.updategallery()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
