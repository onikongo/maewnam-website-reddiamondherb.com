<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("sub_organization","*","id='".$id."'");
	$name = explode("|",$edit['title']);
	$sub = explode("|",$edit['subtitle']);
	$detail = explode("|",base64_decode($edit['detail']));
?>
<script>
...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=organization">Organization</a> / edit</font></div>
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    	<div class="col-md-12" style="padding:10px;">
        	<form class="form form-horizontal" id="eventedit">
            <input type="hidden" name="txtID" value="<?php echo $id;?>">
            <input type="hidden" id="parth" name="parth" value="<?php echo $edit['photo'];?>">
            <input type="hidden" id="parth_2" name="parth_2" value="<?php echo $edit['image'];?>">
                <div class="form-group">
                    <label class="col-sm-2 control-label">Title (EN)</label>
                    <div class="col-sm-8">
                        <input type="text"  class="form-control" id="txtTitleEv" name="txtTitleEv" value="<?php echo $name[0];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Title (TH)</label>
                    <div class="col-sm-8">
                        <input type="text"  class="form-control" id="txtTitleEvth" name="txtTitleEvth" value="<?php echo $name[1];?>">
                    </div>
                </div> 
                <div class="form-group">
                    <label class="col-sm-2 control-label">Sub Description (EN)</label>
                    <div class="col-sm-8">
                        <input type="text"  class="form-control" id="txtSubEv" name="txtSubEv" value="<?php echo $sub[0];?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Sub Description (TH)</label>
                    <div class="col-sm-8">
                        <input type="text"  class="form-control" id="txtSubEvth" name="txtSubEvth" value="<?php echo $sub[1];?>">
                    </div>
                </div> 
                <div class="form-group">
                    <label class="col-sm-2 control-label">Description (EN)</label>
                    <div class="col-sm-8">
                        <textarea type="text"  class="form-control editor" id="txtDesEv" name="txtDesEv" ><?php echo $detail[0];?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Description (TH)</label>
                    <div class="col-sm-8">
                        <textarea type="text"  class="form-control editor" id="txtDesEvth" name="txtDesEvth" ><?php echo $detail[1];?></textarea>
                    </div>
                </div> 
            	...
            	<!--/////////////////300x310/////////////////-->
                <form class="form form-horizontal" id="myFrom" method="post" action="apps/organization/xhr/action-up-photo.php"  role="form" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <?php if($edit['photo']!='')
						{
							?><img src="<?php echo '../../../../'.$edit['photo'];?>" width="300"><?php
						}
						?>
                        </div>
                    ...
                    <button type="button" id="unlik"  class="btn btn-danger"   onclick="fn.app.organization.unlinkMe()" style="display:none;">Delete</button>
                </div>    
               </form>
               <!--/////////////////300x310/////////////////-->
               
               <!--/////////////////613x311/////////////////-->
                <form class="form form-horizontal" id="myFrom_2" method="post" action="apps/organization/xhr/action-up-photo_2.php"  role="form" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        ...
                        <?php if($edit['photo']!='')
						{
							?><img src="<?php echo '../../../../'.$edit['image'];?>" width="300"><?php
						}
						?>
                        </div>
                    ...
                    <button type="button" id="unlik_2"  class="btn btn-danger"   onclick="fn.app.organization.unlinkMe_2()" style="display:none;">Delete</button>
                </div>    
               </form>
               <!--/////////////////613x311/////////////////-->
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.organization.editEvent()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
