...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=organization">Organization</a> / add</font></div>
            ...
            <input type="hidden" id="parth_2" name="parth_2" >
               ...
               <!--/////////////////613x311/////////////////-->
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.organization.addEvent()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
