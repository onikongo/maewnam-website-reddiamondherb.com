var organization = {
	save_vision:function(){
		$.ajax({
			url:"apps/organization/xhr/action-save-vision.php",
			type:"POST",
			dataType:"json",
	...
	save_mission:function(){
		$.ajax({
			url:"apps/organization/xhr/action-save-mission.php",
			type:"POST",
			dataType:"json",
			data:$("#about_mission").serialize(),
			success: function(result){
				if(result==true)
				{
					fn.navigate('view');
	...
	saveImage:function(){
		$.ajax({
			url:"apps/organization/xhr/action-save-image.php",
			type:"POST",
			dataType:"json",
	...
	unlinkMe:function(){
		$.ajax({
			url:"apps/organization/xhr/action-unlinkPhoto.php",
			type:"POST",
			dataType:"json",
			data:{id:$("#parth").val()},
			success: function(result){
	...
	activ:function(id,me){
		$.ajax({
			url:"apps/organization/xhr/action-changeStatus.php",
			type:"POST",
			dataType:"json",
			data:{id:id},
			success: function(result){
	...
	dialog_delete:function(id,me){
		...
		$("#yes").click(function(e) {
			$.ajax({
				url:"apps/organization/xhr/action-deleteorganization.php",
				type:"POST",
				dataType:"json",
				data:{id:id},
				success: function(result){
	...
	updateabout:function(){
		$.ajax({
			url:"apps/organization/xhr/action-update-organization.php",
			type:"POST",
			dataType:"json",
	...
	addEvent:function(){
		$.ajax({
			url:"apps/organization/xhr/action-add-event.php",
			type:"POST",
			dataType:"json",
			...
			success: function(result){
				...
				{
					//fn.navigate('view');
					window.location = '?app=organization';
				}
			}
		},"json");
	},
	editEvent:function(){
		$.ajax({
			url:"apps/organization/xhr/action-update-event.php",
			type:"POST",
			dataType:"json",
	...
	dialog_deleteEvent:function(id,me){
		...
		$("#yes").click(function(e) {
			$.ajax({
				url:"apps/organization/xhr/action-deleteEvent.php",
				type:"POST",
				dataType:"json",
				data:{id:id},
				success: function(result){
...
$.extend(fn.app,{organization:organization});
