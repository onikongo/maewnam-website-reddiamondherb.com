<form id="add_schedule" class="form-horizontal" role="form">
	...
	<fieldset id="time_frame">
		<legend>Time Frame <a href="#" class="btn btn-default" onclick="fn.app.product.schedule.add_time_frame()"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></legend>
		<div class="form-group">
			<label for="txtPhoto" class="col-sm-2 control-label"></label>
