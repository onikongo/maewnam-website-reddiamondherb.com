...
<form id="form_add_product" class="form-horizontal">
	<ul class="nav nav-tabs" role="tablist">
		...
		<li role="presentation"><a href="#tab_schedule" aria-controls="tab_schedule" role="tab" data-toggle="tab">Branch & Schedule</a></li>
	...
	<div class="tab-content" style="margin-top:10px;">
		<div role="tabpanel" class="tab-pane active" id="tab_info">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea  class="form-control editor" id="txtDetail" name="txtDetail" placeholder="Deal Description"></textarea>
				</div>
			</div>
			<div class="form-group">
			...
			<div id="thai" style="display:none;">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text"  class="form-control" id="txtTitleTH" name="txtTitleTH" placeholder="ชื่อไทย">
					</div>
				</div>
				<div class="form-group">
					<label for="txtDetail" class="col-sm-4 control-label">Product Description TH*</label>
					<div class="col-sm-8">
						<textarea  class="form-control editor" id="txtDetailTH" name="txtDetailTH" placeholder="รายละเอียด"></textarea>
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="date" class="form-control" id="txtExpire" name="txtExpire">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 input-group">
					<input type="number" class="form-control" id="txtPrice" name="txtPrice" placeholder="0.00">
			...
			<div class="form-group">
				...
				<div class="col-sm-5 input-group">
					<input type="number" class="form-control" id="txtDiscountPercentage" name="txtDiscountPercentage" placeholder="Discount">
					<div class="input-group-addon">%</div>
					<input type="number" class="form-control" id="txtDiscount" name="txtDiscount" placeholder="Discount">
					<div class="input-group-addon">บาท</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-5 input-group">
					<input type="number" class="form-control" id="txtCommissionPercentage" name="txtCommissionPercentage" placeholder="Discount">
					<div class="input-group-addon">%</div>
					<input type="number" class="form-control" id="txtCommission" name="txtCommission" placeholder="Discount">
					<div class="input-group-addon">บาท</div>
				</div>
			</div> 
			<div class="form-group">
	...
	<div>
		...
		<button type="button" class="btn btn-primary pull-right" onclick="fn.app.product.add()">Save</button>
	</div>
</form>
<script>
