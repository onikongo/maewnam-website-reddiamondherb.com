...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=activity"> Activity & Event</a> / Event List</font></div>
<div class="col-md-12" style="padding:10px;">
	<div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title">Event List</h3>
        <!--<div align="right">-->
            <button type="button"  class="btn btn-danger pull-right but" onclick="fn.navigateEdit('addEvent','<?php echo $id;?>')">Add Event</button>
        <!--</div>-->
      </div>
      <div class="panel-body nopad">
        <div class="table-responsive nopad">
      	...
      	<?php 
		$sql = $dbc->Query("SELECT * FROM sub_activity WHERE activity = '".$id."'");
		$i=0;
		...
		{	
			...
			<tr>
                ...
                <td class="text-center">
        			...
        			<button type="button" class="buticonRem" onClick="fn.app.activity.dialog_deleteEvent('<?php echo $row['id'];?>',this)"><i class="demo-icon icon-cancel">&#xe803;</i></button>
                </td>
                <td class="text-center">
                <?php if($row['status']==1)
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" checked type="checkbox" onClick="fn.app.activity.activEvent('<?php echo $row['id'];?>',this)">
				...
				{
					?><div class="switch">
                        <input id="cmn-toggle-<?php echo $i;?>" class="cmn-toggle cmn-toggle-round" type="checkbox" onClick="fn.app.activity.activEvent('<?php echo $row['id'];?>',this)">
                        <label for="cmn-toggle-<?php echo $i;?>"></label>
                    </div><?php
				}?>
