...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=homepage">Slide photo</a> / add</font></div>
  ...
  <div class="panel-body">
        <?php /*?><div>
              ...
              <ul class="nav nav-tabs" role="tablist">
                ...
                <li id="evet" role="presentation"><a href="#Event" aria-controls="Event" role="tab" data-toggle="tab">Event</a></li>
              </ul>
            
              <!-- Tab panes -->
              <div id="first" class="tab-content" style="padding:10px;"><?php */?>
                    <div role="tabpanel" class="tab-pane active" id="Title">
                        <form class="form form-horizontal" id="activitytitle">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text"  class="form-control" id="txtSub" name="txtSub" placeholder="Deal Title">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Sub Description (TH)</label>
                                <div class="col-sm-8">
                                    <input type="text"  class="form-control" id="txtSubth" name="txtSubth" placeholder="Deal Title">
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-sm-2 control-label"></label>
                                <div class="col-sm-8">
                                    <button class="btn btn-primary pull-right" id="multi-posts" type="button" onClick="fn.app.activity.save_datas()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
                    		...
                    		<div class="col-md-12" style="padding:10px;">
                                <input type="hidden" id="parth" name="parth">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-8">
                                            <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.slidePhoto.saveslide()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
                                            <button type="button"  class="btn btn-default pull-right"   onclick="fn.navigate('view')">Cancel</button>
