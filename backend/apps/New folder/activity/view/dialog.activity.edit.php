<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("activity","*","id='".$id."'");
    	...
    	<div class="col-md-12" style="padding:10px;">
        	<form class="form form-horizontal" id="myFromdetailEdit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.activity.updateactivity()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
