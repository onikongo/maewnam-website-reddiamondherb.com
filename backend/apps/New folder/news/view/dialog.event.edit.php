<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("sub_news","*","id='".$id."'");
  ...
  <div class="panel-body">
    	<div class="col-md-12" style="padding:10px;">
            ...
            <input type="hidden" id="parth_2" name="parth_2" value="<?php echo $edit['image'];?>">
            	...
            	<!--/////////////////300x310/////////////////-->
                <form class="form form-horizontal" id="myFrom" method="post" action="apps/news/xhr/action-up-photo.php"  role="form" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <button type="button" id="unlik"  class="btn btn-danger"   onclick="fn.app.news.unlinkMe()" style="display:none;">Delete</button>
                </div>    
               </form>
               <!--/////////////////300x310/////////////////-->
               
               <!--/////////////////613x311/////////////////-->
                <form class="form form-horizontal" id="myFrom_2" method="post" action="apps/news/xhr/action-up-photo_2.php"  role="form" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                    ...
                    <button type="button" id="unlik_2"  class="btn btn-danger"   onclick="fn.app.news.unlinkMe_2()" style="display:none;">Delete</button>
                </div>    
               </form>
               <!--/////////////////613x311/////////////////-->
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.news.editEvent()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
