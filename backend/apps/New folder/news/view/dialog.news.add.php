        ...
        <?php /*?><div>
              ...
              <div id="first" class="tab-content" style="padding:10px;"><?php */?>
                    <div role="tabpanel" class="tab-pane active" id="Title">
                        <form class="form form-horizontal" id="newstitle">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <button class="btn btn-primary pull-right" id="multi-posts" type="button" onClick="fn.app.news.save_datas()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
