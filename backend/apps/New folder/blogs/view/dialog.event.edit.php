<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("sub_blogs","*","id='".$id."'");
            ...
            <input type="hidden" id="parth_2" name="parth_2" value="<?php echo $edit['image'];?>">
               ...
               <!--/////////////////613x311/////////////////-->
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"></label>
                    <div class="col-sm-8">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.blogs.editEvent()">Save</button><!--type="submit"onclick="fn.app.product.add()"-->
