...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=<?php echo $_REQUEST['app'];?>">category</a> / เพิ่ม</font></div>
  ...
  <div class="panel-body">
    	<div class="col-md-8 col-md-offset-2" style="padding:10px;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.category.savestore()">บันทึก</button>
