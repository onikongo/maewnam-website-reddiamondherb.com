<?php
	...
	switch($section){
		case "view":
			include_once "apps/category/view/dialog.store.table.php";
			break;
		case "add":
			include_once "apps/category/view/dialog.store.add.php";
			break;
		case "edit":
			include_once "apps/category/view/dialog.store.edit.php";
			break;
	}
	echo '</div>';
?>