<?php
	...
	$dbc->Connect();
	$id = $_REQUEST['id'];
	$edit = $dbc->GetRecord("news_categories","*","id='".$id."'");
...
<div class="col-md-12 breadcrumb"><font size="2"><a href="?app=<?php echo $_REQUEST['app'];?>">category</a> / แก้ไข</font></div>
    	...
    	<div class="col-md-8 col-md-offset-2" style="padding:10px;">
        	<form class="form form-horizontal" id="myFromdetailEdit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <button class="btn btn-primary pull-right" id="multi-posts" onClick="fn.app.category.updatestore()">บันทึก</button>
